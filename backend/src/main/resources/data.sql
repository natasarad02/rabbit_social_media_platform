...
INSERT INTO profile (
    ...
    address, activated, registration_time, minute_following, last_follow_time
      ...
      ('ivana@example.com', 'ivana', '$2b$12$4bC1fa0JaOEZYG/eceeLDelbCNVJYtcLJrrSD34laTpLRCziNct.S',
       'Ivana', 'Ivanović', false, 'Administrator', CURRENT_TIMESTAMP, NULL, true, '2024-10-10 15:45:00', 0, NULL), -- password789
      ('bojan@example.com', 'bojan', '$2b$12$j4M37/WpAurLS/KlWoke2Oa0fdAoikEfbqepfWrtN0euqSOS4T.Nq',
       'Bojan', 'Bojanović', false, 'Administrator', CURRENT_TIMESTAMP, NULL, true, '2024-10-12 09:15:00', 0, NULL), -- password101
      ('jane@example.com', 'jane', '$2b$12$CyUjPoyeQbENBzVNCsqnBe08ZTCjk2X5WjEspmvxBrCx7ZMMdV/OC',
       'Jane', 'Doe', false, 'User', CURRENT_TIMESTAMP, NULL, true, '2024-10-15 14:20:00', 0, NULL), -- password202
      ('alex@example.com', 'alex', '$2b$12$siwPZyZpPMG8WaYzp1YjCeBSBEt1.LV85sKh1T/fuJCjDcqTEHIaa',
       'Alex', 'Smith', false, 'User', CURRENT_TIMESTAMP, NULL, true, '2024-10-18 16:40:00', 0, NULL), -- password303
      ('lisa@example.com', 'lisa', '$2b$12$PiY9CaeNOA/plJ76ZrYHUOa/xfhdSHh4SIbwRANv8okkkCV6LmwTu',
       'Lisa', 'Johnson', false, 'User', CURRENT_TIMESTAMP, NULL, true, '2024-10-20 12:00:00', 51, CURRENT_TIMESTAMP), -- password404
      ('john@example.com', 'john', '$2b$12$3rPK12xTrJy8v.iaHxG6s.bNefU8dJmQnLxuVca8kHx8mxFIRdA6K',
       'John', 'Doe', false, 'User', CURRENT_TIMESTAMP, NULL, true, '2024-10-22 18:25:00', 0, NULL), -- password505
